...
wire sdram_cntl_1_host_intf_done_o;
...
wire [23:0] sdram_cntl_1_host_intf_addr_i;
...
wire sdram_cntl_1_host_intf_rd_i;
reg [4:0] sdram_cntl_1_wrpipeline_x;
wire sdram_cntl_1_host_intf_wr_i;
...
assign sdram_cntl_1_host_intf_addr_i = 24'd0;
assign sdram_cntl_1_host_intf_data_i = 16'd0;
assign sdram_cntl_1_host_intf_rd_i = 1'd0;
assign sdram_cntl_1_host_intf_wr_i = 1'd0;
assign sdram_cntl_1_sd_intf_dq = sdram_cntl_1_sdriver;


always @(sdram_cntl_1_ba_x, sdram_cntl_1_ba_r, sdram_cntl_1_row_s, sdram_cntl_1_bank_s, sdram_cntl_1_cmd_r, sdram_cntl_1_activebank_r, sdram_cntl_1_doactivate_s, sdram_cntl_1_state_r, sdram_cntl_1_activate_in_progress_s, sdram_cntl_1_activeflag_r[0], sdram_cntl_1_activeflag_r[1], sdram_cntl_1_activeflag_r[2], sdram_cntl_1_activeflag_r[3], sdram_cntl_1_rdpipeline_r, sdram_cntl_1_col_s, sdram_cntl_1_wr_in_progress_s, sdram_cntl_1_activerow_r[0], sdram_cntl_1_activerow_r[1], sdram_cntl_1_activerow_r[2], sdram_cntl_1_activerow_r[3], sdram_cntl_1_timer_r, sdram_cntl_1_wrtimer_r, sdram_cntl_1_rfshcntr_r, sdram_cntl_1_sdatadir_r, sdram_cntl_1_rd_in_progress_s, sdram_cntl_1_rastimer_r, sdram_cntl_1_saddr_r, sdram_cntl_1_reftimer_r, sdram_cntl_1_host_intf_rd_i, sdram_cntl_1_host_intf_wr_i) begin: SDRAMTEST_SDRAM_CNTL_1_COMB_FUNC
    integer index;
    ...
    if ((sdram_cntl_1_timer_r != 0)) begin
        ...
        case (sdram_cntl_1_state_r)
            ...
            3'b100: begin
                ...
                else if (sdram_cntl_1_host_intf_rd_i) begin
                ...
                else if (sdram_cntl_1_host_intf_wr_i) begin
                    if ((sdram_cntl_1_ba_x == sdram_cntl_1_ba_r)) begin
                        if (sdram_cntl_1_doactivate_s) begin
                            if (((!sdram_cntl_1_activate_in_progress_s) && (!sdram_cntl_1_wr_in_progress_s) && (!sdram_cntl_1_rd_in_progress_s))) begin
                                sdram_cntl_1_cmd_x = 2;
...
always @(posedge clock, posedge None) begin: SDRAMTEST_SDRAM_CNTL_1_SEQ_FUNC
    integer index;
    if (False == 1) begin
        sdram_cntl_1_ba_r <= 0;
...
always @(sdram_cntl_1_bank_s, sdram_cntl_1_cmd_r, sdram_cntl_1_saddr_r, sdram_cntl_1_sdatadir_r, sdram_cntl_1_sdata_r) begin: SDRAMTEST_SDRAM_CNTL_1_SDRAM_PIN_MAP
...
assign sdram_cntl_1_host_intf_done_o = (sdram_cntl_1_rdpipeline_r[0] || sdram_cntl_1_wrpipeline_r[0]);
assign sdram_cntl_1_host_intf_data_o = sdram_cntl_1_sdramdata_r;
assign sdram_cntl_1_host_intf_rdPending_o = sdram_cntl_1_rd_in_progress_s;
assign sdram_cntl_1_sdata_x = sdram_cntl_1_host_intf_data_i;



assign sdram_cntl_1_bank_s = sdram_cntl_1_host_intf_addr_i[((2 + 13) + 9)-1:(13 + 9)];
assign sdram_cntl_1_ba_x = sdram_cntl_1_host_intf_addr_i[((2 + 13) + 9)-1:(13 + 9)];
assign sdram_cntl_1_row_s = sdram_cntl_1_host_intf_addr_i[(13 + 9)-1:9];
assign sdram_cntl_1_col_s = sdram_cntl_1_host_intf_addr_i[9-1:0];


always @(sdram_cntl_1_activeflag_r[0], sdram_cntl_1_activeflag_r[1], sdram_cntl_1_activeflag_r[2], sdram_cntl_1_activeflag_r[3], sdram_cntl_1_row_s, sdram_cntl_1_activerow_r[0], sdram_cntl_1_activerow_r[1], sdram_cntl_1_activerow_r[2], sdram_cntl_1_activerow_r[3], sdram_cntl_1_sd_intf_dq, sdram_cntl_1_sdramdata_r, sdram_cntl_1_wrtimer_r, sdram_cntl_1_rdpipeline_r, sdram_cntl_1_bank_s, sdram_cntl_1_rastimer_r, sdram_cntl_1_activebank_r) begin: SDRAMTEST_SDRAM_CNTL_1_DO_ACTIVE
